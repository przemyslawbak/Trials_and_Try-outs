...
for x in range(repeats):
    ...
    #model2 - recurrent activation
    model2 = Sequential()
    model2.add(LSTM(100, activation='relu', input_shape=(60, 4), recurrent_activation=None))
    model2.add(RepeatVector(4))
    model2.add(LSTM(100, activation='relu', return_sequences=True, recurrent_activation=None))
...
#CONCLUSION: it will not work anyway
