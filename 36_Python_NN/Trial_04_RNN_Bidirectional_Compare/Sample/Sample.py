...
for x in range(repeats):
    ...
    model2 = Sequential()
    model2.add(Bidirectional(LSTM(100, activation='relu', input_shape = (60, 4))))
...
print('Mean of results 1: ' + str(mean_res1)) #4.171385808149353e-05
print('Mean of results 2: ' + str(mean_res2)) #9.012429945869372e-05

#CONCLUSION: loosing with Bidirectional (?)
