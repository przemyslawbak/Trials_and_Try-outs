...
for x in range(100):
    ...
    model2.add(Bidirectional(forward_layer, backward_layer=backward_layer, input_shape=(3, 1)))
...
print('Mean of results 1: ' + str(mean_res1)) #5.145452976226807
print('Mean of results 2: ' + str(mean_res2)) #29050.69921875
