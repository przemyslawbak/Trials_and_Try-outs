...
from keras.layers import Flatten, LSTM, Attention, BatchNormalization
...
print('Mean of results 1: ' + str(mean_res1)) #2.93977687805891
print('Mean of results 2: ' + str(mean_res2)) #3.083416835963726
