...
namespace HelloML_App
{
    public partial class MLModel1
    {
        public const string RetrainFilePath =  @"C:\Users\przem\Downloads\sentiment labelled sentences\sentiment labelled sentences\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.034281127F,L2Regularization=0.48499542F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
