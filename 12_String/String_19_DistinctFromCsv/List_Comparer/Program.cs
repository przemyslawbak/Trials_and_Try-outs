...
namespace List_Comparer
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string[] blacklist = new string[] { "ir@", "admin", "corporate", "spam", "account", "invoice", "charter", "book", "business", "cruise", "customer", "protection", "invest", "financ", "firstname", "lastname", "freight", "hotel", "airport", "it@", "library", "marketing", "media", "privacy", "proxy", "purchasing", "reservations", "sales", "webmaster", "customer", "abuse" };
