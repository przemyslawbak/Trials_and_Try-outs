...
@onready var next_turn_button: Button		  = $UI/MarginContainer/HBoxContainer/NextTurnButton
...
@onready var turn_no_label: Label = $UI/MarginContainer/HBoxContainer/TurnNoLabel
