...
remTestX = X_test_splitted.shape[0] % mlSetup.num_batch
remTesty = y_test_splitted.shape[0] % mlSetup.num_batch
remTrainX = X_train_splitted.shape[0] % mlSetup.num_batch
remTrainy = y_train_splitted.shape[0] % mlSetup.num_batch
