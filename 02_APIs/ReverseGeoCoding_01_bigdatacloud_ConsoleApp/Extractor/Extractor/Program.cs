        ...
        private static async Task<List<string>> GetCities()
        {
            ...
            using (var reader = new StreamReader("_coordLines.txt"))
            {
                ...
                while (!reader.EndOfStream)
                {
                    ...
                    string page = @"https://api.bigdatacloud.net/data/reverse-geocode?latitude=" + lat + "&longitude=" + lon + "&localityLanguage=en&key=<KEY>";
                    ...
                    using (HttpClient client = new HttpClient())
                    {
                        try
                        {
                            ...
                            using (HttpContent content = response.Content)
                            {
                                ...
                                string city = joResponse.SelectToken("city").ToString();
