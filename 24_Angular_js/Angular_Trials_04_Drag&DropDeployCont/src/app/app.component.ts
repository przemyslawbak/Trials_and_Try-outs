...
export class AppComponent {
  ...
  public rotate(id: number): void {
    let item: ShipComponent = this.list1[id];
  ...
  private createFleet(): Array<ShipComponent> {
    return [
      { size: 4, rotate: false, top: 0, left: 0, deployed: false, rotation: 0 },
      { size: 3, rotate: false, top: 0, left: 0, deployed: false, rotation: 0 },
      { size: 3, rotate: false, top: 0, left: 0, deployed: false, rotation: 0 },
      { size: 2, rotate: false, top: 0, left: 0, deployed: false, rotation: 0 },
      { size: 2, rotate: false, top: 0, left: 0, deployed: false, rotation: 0 },
      { size: 2, rotate: false, top: 0, left: 0, deployed: false, rotation: 0 },
      { size: 1, rotate: false, top: 0, left: 0, deployed: false, rotation: 0 },
      { size: 1, rotate: false, top: 0, left: 0, deployed: false, rotation: 0 },
      { size: 1, rotate: false, top: 0, left: 0, deployed: false, rotation: 0 },
      { size: 1, rotate: false, top: 0, left: 0, deployed: false, rotation: 0 },
    ];
